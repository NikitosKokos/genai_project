...
const LogoIcon = ({ className = 'size-10' }: { className?: string }) => (
   <div
      className={`${className} flex items-center justify-center relative transition-transform duration-300 group-hover:scale-105`}>
      <svg
         width="100%"
         height="100%"
         viewBox="0 0 40 40"
         ...
         <header className="border-b bg-white dark:bg-zinc-950 px-6 py-4 flex items-center justify-between sticky top-0 z-40 backdrop-blur-sm bg-white/80 dark:bg-zinc-950/80">
            <div className="flex items-center gap-3 cursor-pointer group" onClick={handleLogoClick}>
               ...
               <div>
                  ...
                  <p className="text-xs text-zinc-500 font-medium group-hover:text-emerald-600/70 transition-colors">
                     AI WealthOS
                  </p>
               </div>
            </div>
            ...
            <button
               ...
               aria-label="Profile"
               onClick={() =>
                  alert('Privacy and security settings (not implemented in this demo).')
               }>
            ...
            <div
               ...
               <div
                  ...
                  <div className="flex flex-col items-center text-center mb-8">
                     <div className="size-20 bg-gradient-to-br rounded-2xl flex items-center justify-center shadow-xl shadow-zinc-950/20 mb-4 p-4 group bg-zinc-950/50">
                        <LogoIcon className="size-full" />
                     </div>
                     <h2 className="text-3xl font-bold mb-2">Welcome to Nova</h2>
                     <p className="text-zinc-500 text-lg">
                        Your Intelligent Wealth Operating System
                     </p>
                  </div>

                  <div className="space-y-6">
                     <p className="text-zinc-700 dark:text-zinc-300 leading-relaxed">
                        Nova simplifies your financial life by combining advanced <b>AI insights</b>{' '}
                        with intuitive <b>portfolio management</b>. Whether you're tracking
                        performance or discovering new assets, Nova brings everything into one{' '}
                        <b>seamless</b> platform.
                     </p>
                     ...
                     <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-xl border border-zinc-100 dark:border-zinc-800">
                           ...
                           <p className="text-xs text-zinc-500">
                              Real-time market intelligence tailored to your portfolio.
                           </p>
                        </div>
                        <div className="p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-xl border border-zinc-100 dark:border-zinc-800">
                           <h3 className="font-semibold mb-1 flex items-center gap-2">
                           ...
                           <p className="text-xs text-zinc-500">
                              Trade, track, and analyze all your assets in one place.
                           </p>
                        </div>
                     </div>
